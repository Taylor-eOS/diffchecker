...
class DiffCheckerApp:
    def __init__(self):
        ...
        self.left_map = []       # Maps aligned line index → original line index or None
        self.right_map = []      # Same for right side
        self.setup_widgets()
        self.root.mainloop()
    ...
    def setup_widgets(self):
        ...
        # Vertical scrollbars that scroll both panes together
        ...
        # Bind Ctrl+A and Ctrl+C to both text widgets
        ...
        # Also sync mouse wheel scrolling on Windows/macOS and Linux
    ...
    def compare_texts(self):
        ...
        # Read original lines and store for copy mapping
            ...
            if tag == "equal":
                ...
                for k in range(max_len):
                    if k < len(left_segment):
                        ...
                        aligned_left.append("")      # placeholder
                    ...
                    if k < len(right_segment):
                        ...
                        aligned_right.append("")     # placeholder
        ...
        # Clear and insert aligned content for visual display
